<?php
	...
	class Vote_option extends MY_Controller
	{
		...
		protected $names_to_sort = array(
			'vote_id', 'name', 'description', 'url_image', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id', 'status',
		);
		...
		protected $names_to_return = array(
			'option_id', 'vote_id', 'name', 'description', 'url_image', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id', 'status',
		);
