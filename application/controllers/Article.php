<?php
	...
	class Article extends MY_Controller
	{
		...
		protected $names_create_required = array(
			'user_id', 'category_id', 'title', 'excerpt', 'content', 
		);
		...
		public function create()
		{
			...
			$this->form_validation->set_rules('category_id', '所属分类ID', 'trim|required|is_natural_no_zero');
			$this->form_validation->set_rules('title', '标题', 'trim|required|max_length[30]');
			$this->form_validation->set_rules('excerpt', '摘要', 'trim|required|min_length[10]|max_length[100]');
			$this->form_validation->set_rules('content', '内容', 'trim|required|min_length[10]|max_length[5000]');
		...
		public function edit_certain()
		{
			...
			$this->form_validation->set_rules('excerpt', '摘要', 'trim|min_length[10]|max_length[100]');
			$this->form_validation->set_rules('content', '内容', 'trim|min_length[10]|max_length[5000]');
			$this->form_validation->set_rules('url_name', '自定义域名', 'trim|max_length[30]');
			$this->form_validation->set_rules('url_images', '形象图', 'trim');
